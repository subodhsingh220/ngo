...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        $this->_blockGroup = 'Magpieinfotech_Campaign';
    ...
    {
        if ($this->_coreRegistry->registry('campaign')->getId()) {
            return __("Edit Campaign '%1'", $this->escapeHtml($this->_coreRegistry->registry('campaign')->getTitle()));
        } else {
    ...
    {
        return $this->getUrl('campaign/*/save', ['_current' => true, 'back' => 'edit', 'active_tab' => '{{tab_id}}']);
    }
