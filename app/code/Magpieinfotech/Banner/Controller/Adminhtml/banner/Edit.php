...
namespace Magpieinfotech\Banner\Controller\Adminhtml\banner;
...
class Edit extends \Magento\Backend\App\Action
{
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Magpieinfotech_Banner::Banner')
            ->addBreadcrumb(__('Magpieinfotech Banner'), __('Magpieinfotech Banner'))
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create('Magpieinfotech\Banner\Model\Banner');
