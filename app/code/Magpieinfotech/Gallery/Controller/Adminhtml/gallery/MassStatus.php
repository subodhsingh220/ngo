...
class MassStatus extends \Magento\Backend\App\Action
{
    ...
    {
        $itemIds = $this->getRequest()->getParam('gallery');
        if (!is_array($itemIds) || empty($itemIds)) {
            ...
            try {
                ...
                foreach ($itemIds as $postId) {
                    $post = $this->_objectManager->get('Magpieinfotech\Gallery\Model\Gallery')->load($postId);
        ...
        return $this->resultRedirectFactory->create()->setPath('gallery/*/index');
    }
